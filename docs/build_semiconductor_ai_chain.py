...
GROUP_META = {
    ...
    "電源管理 / 類比 IC":         {"stage": "上游", "desc": "PMIC、AC/DC、MOSFET、類比與電源控制 IC，連到 AI 伺服器電力效率題材。", "color": "#84cc16"},
...
REPRESENTATIVE_GROUPS = {
    ...
    "PMIC":   ["6415", "8081", "6138", "3588", "2436"],
    "CPO":    ["4979", "4908", "3163", "3450", "3596"],
    "光學影像":["3008", "3406", "3019", "3504", "6789"],
...
MANUAL_GROUPS = {
    ...
    "消費性 / 常規 IC設計": [
        ...
        "6716", "6756", "6909", "7556",
        # 從「半導體其他」移入：IC設計公司
        "6568",  # 宏觀微電子：射頻 IC 設計（RF IC，Fabless）
    ],
    "晶圓代工 / 功率半導體": [
    ...
    "封測 / 測試介面": [
        ...
        "3030",
        # 從「半導體其他」移入：功率導線架（封裝材料）
        "5285",  # 界霖：功率元件導線架，封裝製程關鍵材料，車用/AI伺服器應用
    ],
    "記憶體 / HBM": [
    ...
    "電源管理 / 類比 IC": [
        "2436", "3257", "3317", "3438", "3588", "6138", "6291", "6415", "6651", "6799",
        "6996", "8081",
    ],
    "矽晶圓 / 材料設備 / 廠務": [
        ...
        "2404", "6139", "6196", "6215", "6438", "6691", "6698",
        # 從「半導體其他」移入：半導體設備儀器工程
        "7730",  # 暉盛-創：半導體儀器設備工程（電中游-儀器設備工程）
        "7828",  # 創新服務：半導體設備維修服務大廠（電中游-儀器設備工程）
    ],
    "PCB / 載板 / CCL": [
        "3037", "8046", "3189", "2383", "2368", "6274", "4958", "6269", "2313", "6191",
        "5469", "2367",
        "3044", "3645", "3715", "6213", "6672", "8039", "8213", "6108", "6153",
    ],
    "AI伺服器 / 機櫃組裝": [
    ...
    "散熱": [
        ...
        # 從「高速互連/連接器/線材」移入：AI伺服器液冷快接頭(QD)核心廠
        "6805",  # 富世達：折疊手機轉軸龍頭轉型，AI伺服器水冷QD快接頭/浮動接頭/NVQD，GB200/GB300主要供應商
    ],
    "電源 / BBU": [
    ...
    "光學 / 影像 / 顯示": [
        "2409", "3008", "3019", "3362", "3406", "3454", "3481", "3504", "3630", "4976",
        "6209", "6789",
        "2458", "3034", "3141", "3227", "3527", "3530", "3545", "3556", "3592", "4961",
        "5236", "6684", "6695", "6962", "8016",
    ],
    "高速互連 / 連接器 / 線材": [
        "3023", "3665", "6279", "6205", "3217", "3376",
        "2392", "2462", "3533", "6133", "6197", "6272", "6715", "8103",
    ],
    "低軌衛星 / SpaceX": [
